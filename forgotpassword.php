...
<html lang="pt">
    <head>
        ...
        <!-- custom css -->
        <link rel="stylesheet" href="/css/styleForgotPass.css">
        ...
        <div class="container-main d-flex justify-content-center">
            ...
            <div class="card" style="width: 520px; height: 400px;">
                   ...
                   <form class="form-sign-up" action="" method="post">
                       ...
                       <div class="form-row"> 
                             <div class="col">
                                <button type="submit" class="btn btn-success btn-block btn-lg">enviar redefinição de senha</button>
                            </div>
                        ...
                        <div class="d-flex justify-content-center"> 
                            <div class="p-2">
                                <span class="text-secondary">lembrou sua senha? <a href="index.php">Login</a></span>
                           </div>
                      </div><!-- end form-row button -->
